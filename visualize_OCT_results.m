...
% =========================================================================
    ...
    str_lines = {
        '═══ E-Value Summary ═══', '', ...
        'Cycle 1:', ...
        sprintf('  E1(1.67%%) = %.2f kPa', E_c1(1)), ...
        sprintf('  E2(3.34%%) = %.2f kPa', E_c1(2)), ...
        sprintf('  E3(5.0%%)  = %.2f kPa', E_c1(3)), '', ...
        'Cycle 2:', ...
        sprintf('  E1(1.67%%) = %.2f kPa', E_c2(1)), ...
        sprintf('  E2(3.34%%) = %.2f kPa', E_c2(2)), ...
        sprintf('  E3(5.0%%)  = %.2f kPa', E_c2(3)), '', ...
        'Cycle 3:', ...
        sprintf('  E1(1.67%%) = %.2f kPa', E_c3(1)), ...
        sprintf('  E2(3.34%%) = %.2f kPa', E_c3(2)), ...
        sprintf('  E3(5.0%%)  = %.2f kPa', E_c3(3)), '', ...
        '─── Average ───', ...
        sprintf('  E1(1.67%%) = %.2f kPa', E_avg(1)), ...
        sprintf('  E2(3.34%%) = %.2f kPa', E_avg(2)), ...
        sprintf('  E3(5.0%%)  = %.2f kPa', E_avg(3))
    };
